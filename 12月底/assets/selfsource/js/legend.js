...
LineOption = {
    ...
    series: [{
        name: '固定资产',
        type: 'line',
        data: [0.42, 0.5, 0.3, 0.39, 0.55, 0.2, 0.6,0.85, 0.2, 0.6,0.8],
		symbolSize:6,
		symbol:'circle',
		markPoint: {
        ...
        data: [0.32, 0.2, 0.4, 0.7, 0.3, 0.2, 0.7, 0.39, 0.55, 0.2, 0.6]
    }, {
        name: '运维费用',
        type: 'line',
		label:{
        ...
        data: [0.22, 0.5, 0.3, 0.49, 0.3, 0.8, 0.1, 0.39, 0.55, 0.2, 0.6]
    }]
};
